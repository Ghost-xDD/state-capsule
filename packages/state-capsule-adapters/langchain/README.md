# @state-capsule/adapter-langchain

State Capsule `BaseMemory` subclass + Runnable wrapper for [LangChain.js](https://github.com/langchain-ai/langchainjs). Every chain step is checkpointed as a signed capsule on 0G Storage — agents can resume from the last capsule after a crash.
